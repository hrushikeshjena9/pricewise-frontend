...
const SmartphonePersonalleftside = ({
  setCount,
  showCompactContent,
  ...
  const [prijsklasse, setPrijsklasse] = useState(0);
  return (
    <>
      <div className="col-lg-6 eventbxleft ">
        ...
        <div className="form-sec cyberbxleft cyberbxleft2">
          ...
          <div className="row">
            <div className="col">
              <label className="form-label labeltitle">Bellen/sms&#x27;en</label>
            </div>
            <div className="col">
              <input
                type="number"
...
export default SmartphonePersonalleftside;
